...
If you're using a [ReSpeaker mic array](https://respeaker.io/2_mic_array/), you need to install the driver before continuing. If not, proceed to the [Installing Rhasspy](#installing-rhasspy) step.
